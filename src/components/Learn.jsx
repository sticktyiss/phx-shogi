      ...
      <div>
        ...
        <div className="pieceMoves">
          ...
          <ul>
            ...
            <li>
              <h3>
                Silver General<span className="madeRed">*</span>
              </h3>
            ...
            <li>
              <h3>
                Knight<span className="madeRed">*</span>
              </h3>
            ...
            <li>
              <h3>
                Lance<span className="madeRed">*</span>
              </h3>
            ...
            <li>
              <h3>
                Pawn<span className="madeRed">*</span>
              </h3>
              <p>1 space forward</p>
              <img src={pawn} />
            </li>
            <li>
              <h5>
                Any piece with <span className="madeRed">*</span> promotes to a
                Gold General
              </h5>
              <img src={gold} />
            </li>
